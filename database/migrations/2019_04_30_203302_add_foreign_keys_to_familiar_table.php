...
class AddForeignKeysToFamiliarTable extends Migration {
	...
	public function up()
	{
		Schema::table('familiar', function(Blueprint $table)
		{
			...
			$table->foreign('pessoa_perdida_id_pessoa_perdida', 'fk_familiar_pessoa_perdida1')->references('id_p_perdida')->on('pessoa_perdida')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
